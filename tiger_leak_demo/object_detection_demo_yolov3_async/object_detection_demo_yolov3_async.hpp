...
//
#ifndef OBJECT_DETECTION_DEMO_YOLOV3_ASYNC_H
#define OBJECT_DETECTION_DEMO_YOLOV3_ASYNC_H
//#pragma once
...
/// It is a required parameter
DEFINE_string(m, "/data/github_repos/yolov3-tiny-fit-ncs/ncs2/OpenVINO/model_optimizer/FP16/20190104102512_TinyYoloV3NCS.xml", model_message);

/// \brief Defines the target device to infer on <br>
DEFINE_string(d, "HDDL", target_device_message);
...
/// It is an optional parameter
DEFINE_double(t, 0.3, thresh_output_message);
