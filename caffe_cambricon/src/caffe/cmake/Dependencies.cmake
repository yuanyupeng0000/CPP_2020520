...
list(APPEND Caffe_OFFLINE_LINKER_LIBS PUBLIC ${Boost_LIBRARIES})

# ---[ Threads
find_package(Threads REQUIRED)
list(APPEND Caffe_LINKER_LIBS PRIVATE ${CMAKE_THREAD_LIBS_INIT})
list(APPEND Caffe_OFFLINE_LINKER_LIBS PRIVATE ${CMAKE_THREAD_LIBS_INIT})
...
list(APPEND Caffe_OFFLINE_LINKER_LIBS PUBLIC ${GLOG_LIBRARIES})

# ---[ Google-gflags
include("cmake/External/gflags.cmake")
list(APPEND Caffe_INCLUDE_DIRS PUBLIC ${GFLAGS_INCLUDE_DIRS})
list(APPEND Caffe_LINKER_LIBS PUBLIC ${GFLAGS_LIBRARIES})
list(APPEND Caffe_OFFLINE_LINKER_LIBS PUBLIC ${GFLAGS_LIBRARIES})
...
if(USE_MLU)
  ...
  include_directories(SYSTEM ${CNPLUGIN_INCLUDE_DIR})
  list(APPEND Caffe_LINKER_LIBS  PUBLIC ${CNML_LIBRARY})
  list(APPEND Caffe_LINKER_LIBS  PUBLIC ${CNRT_LIBRARY})
  list(APPEND Caffe_OFFLINE_LINKER_LIBS  PUBLIC ${CNRT_LIBRARY})
  list(APPEND Caffe_LINKER_LIBS  PUBLIC ${CNPLUGIN_LIBRARY})
...
if(USE_OPENCV)
  ...
  list(APPEND Caffe_OFFLINE_LINKER_LIBS PUBLIC ${OpenCV_LIBS})
