...
# Android NDK
set(ANDROID_NDK_EXPECTED_PATH $ENV{ARM64_R17_NDK_ROOT})
if(NOT ANDROID_NDK_EXPECTED_PATH)
    message(SEND_ERROR "ARM64_R17_NDK_ROOT NOT SET. EXIT.")
endif()
if(NOT ANDROID_NDK)
...
list(APPEND CMAKE_FIND_ROOT_PATH "${ADDITIONAL_FIND_PATH}")
...
#add NEUWARE_HOME to rapth-link so that libipu_smmu.so can be located.
list(APPEND ANDROID_LINKER_FLAGS "-Wl,-rpath-link,${NEUWARE_HOME}/lib64")
list(APPEND ANDROID_LINKER_FLAGS "-Wl,-rpath-link,${NEUWARE_HOME}/lib64")
