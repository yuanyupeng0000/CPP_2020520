...
do_run()
{
    ...
    run_cmd="$CAFFE_DIR/build/examples/faster-rcnn/faster-rcnn_offline_multicore$SUFFIX \
...
# faster-rcnn: batchsize must be equal to core_number
bscn_list=(
   # '1  1 '
   # '1  4 '
   # '1  16'
...
for network in "${network_list[@]}"; do
    ...
    echo "===================================================="
    echo "running ${network} offline - ${ds_name}, Bangop..."
