...
do_run()
{
    ...
    run_cmd="$CAFFE_DIR/build/examples/segnet/segnet_offline_singlecore$SUFFIX -offlinemodel $CURRENT_DIR/offline.cambricon -images $CURRENT_DIR/$file_list &>> $CURRENT_DIR/$log_file"
