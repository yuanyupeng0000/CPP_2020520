...
struct base_any_policy
{
    ...
    virtual void print_cv(std::ostream& out, void* const* src) = 0;
...
struct small_any_policy : typed_base_any_policy<T>
{
    ...
    virtual void print_cv(std::ostream& out, void* const* src) { out << *reinterpret_cast<T const*>(src); }
};
...
template<> inline void big_any_policy<flann_centers_init_t>::print_cv(std::ostream& out, void* const* src)
{
    out << int(*reinterpret_cast<flann_centers_init_t const*>(*src));
}

template<> inline void big_any_policy<flann_algorithm_t>::print_cv(std::ostream& out, void* const* src)
{
    out << int(*reinterpret_cast<flann_algorithm_t const*>(*src));
}

template<> inline void big_any_policy<cv::String>::print_cv(std::ostream& out, void* const* src)
{
...
{
    any_val.policy->print_cv(out,&any_val.object);
    return out;
}
